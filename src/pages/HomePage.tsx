...
const HeroSection: React.FC<{ settings: StoreSettings, onExploreClick: () => void }> = ({ settings, onExploreClick }) => {
  ...
  return (
    <section 
      ...
      style={heroStyle}
    >
      <div className="container mx-auto flex flex-col items-center justify-center px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-32 bg-black/50 backdrop-blur-sm">
        <h1 
