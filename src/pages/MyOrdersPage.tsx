    ...
    return (
        <div className="w-full pt-4">
            <div className="flex justify-between">
                {statuses.map((s, index) => (
                    <div key={s} className="flex flex-col items-center flex-1 text-center">
                        <div className={`h-4 w-4 rounded-full ${index <= currentIndex ? 'bg-accent-teal' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
            ...
            <div className="relative h-1 bg-gray-300 dark:bg-gray-600 rounded-full -mt-5" style={{zIndex: -1}}>
                <div 
                    className="absolute top-0 left-0 h-1 bg-accent-teal rounded-full transition-all duration-500" 
