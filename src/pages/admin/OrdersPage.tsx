...
const getPaymentStatusClasses = (status: 'Paid' | 'Unpaid') => {
    const base = "p-1.5 rounded-md border text-sm focus:ring-accent-teal focus:border-accent-teal font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed";
    switch (status) {
        case 'Paid':
            return `${base} bg-green-100 border-green-200 text-green-800 dark:bg-green-500/10 dark:border-green-500/20 dark:text-green-400`;
        case 'Unpaid':
